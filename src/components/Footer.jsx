    ...
    <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
      <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
        ...
        <p className="py-8 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left">
          Trusted in more than 200+ clients &amp; 5 million customers. Have any
          query ?
        </p>
        <a
      ...
      <div className="lg:mx-auto text-left ">
        <h4 className="text-lg text-gray-900 font-medium mb-7">DREAM WHEEL MOTORS</h4>
    ...
    <div className="py-7 border-t border-gray-200">
      <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
        <span className="text-sm text-gray-500 ">
          ©<a href="">Dream Wheel Motors</a> {new Date().getFullYear()}, All rights
          reserved.
        </span>
        <div className="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
          ...
          <a
            href="http://instagram.com/dreamwheel_motors" target='_blank'
